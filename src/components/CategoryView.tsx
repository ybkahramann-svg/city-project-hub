    ...
    <div className="space-y-10">
      {grouped.map(([category, items]) => (
        <div key={category}>
          ...
          {/* Table header */}
          <div className="flex items-center gap-4 px-3 py-2 border-b border-border/60 text-[10px] uppercase tracking-wider text-muted-foreground font-semibold">
            <div className="w-14 flex-shrink-0" />
            <div className="flex-1 min-w-0">Proje</div>
            <div className="hidden md:block w-[140px] flex-shrink-0">Konum</div>
            <div className="hidden sm:block w-[160px] flex-shrink-0">Durum</div>
